package id.indocyber.movieapp.fragment.movie
...
import id.indocyber.movieapp.databinding.MoviesFragmentLayoutBinding
import id.indocyber.movieapp.view_model.DiscoverMovieViewModel
...
class DiscoverMovieFragment : BaseFragment<DiscoverMovieViewModel, MoviesFragmentLayoutBinding>() {
    ...
    val adapter = DiscoverMoviePagingAdapter() {
        findNavController().navigate(
            DiscoverMovieFragmentDirections.toMovieDetails(it)
        )
    }
